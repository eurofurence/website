...
<section>
	...
	<h2 class="uk-margin-remove-top">Content</h2>
	<p>
		<ul class="uk-column-1-2@l uk-column-divider">
			<li><a href="accessibility#queuing" title="Queuing">Queuing</a></li>
			<li><a href="accessibility#seating" title="Seating">Seating</a></li>
			<li><a href="accessibility#content-ratings" title="Content Ratings/Warnings">Content Ratings/Warnings</a></li>
			<li><a href="accessibility#venue" title="Venue">Venue</a></li>
			<li><a href="accessibility#dealers-den" title="The Dealers’ Den">The Dealers’ Den</a></li>
			<li><a href="accessibility#quiet-rooms" title="The Quiet Room">The Quiet Rooms</a></li>
			<li><a href="accessibility#service-animals" title="Service Animals">Service Animals</a></li>
			<li><a href="accessibility#accompanying-persons" title="Accompanying Persons">Accompanying Persons</a></li>
			<li><a href="accessibility#gender-neutral-bathrooms" title="Gender-neutral Bathrooms">Gender-neutral Bathrooms</a></li>
			<li><a href="accessibility#sign-language" title="Sign Language Interpretation and Live Captioning">Sign Language Interpretation and Live Captioning</a></li>
			<li><a href="accessibility#website" title="Our Website">Our Website</a></li>
			<li><a href="accessibility#feedback-and-contact" title="Feedback and Contact">Feedback and Contact</a></li>
		</ul>
	</p>
</section>

<section class="uk-column-1-2@l uk-column-divider">
	<div>
		<h2 id="queuing">Queuing</h2>
		<p>Attendees who are disabled, rely on a mobility aid, or temporarily injured in a way that limits their ability to walk or stand for longer periods of time are eligible for a Priority Access Wearable (P.A.W.).</p>
		<p>P.A.W.s are available at the Eurofurence Info Desk, and enable our security team to guide attendees inside an event immediately as soon as the command to open doors is given.</p>
		<p>Having a disability ID or medical certificate present when requesting a P.A.W. is helpful.</p>
	...
	<div>
		...
		<p>Dedicated seating is typically reserved for wheelchair/mobility aid users and physically disabled attendees - just ask a member of queue security at the event for assistance.</p>
	...
	<div>
		<h2 id="content-ratings">Content Ratings/Warning</h2>
		<p>For EF30 we have Content Ratings available for Pawpet Show, Furry Tails Theater and Orchestra. You can find the ratings in the EF App via the menu ("More" > "Info articles" > "General Information") or get it at the Info Desk.</p>
...
However, occasional technical issues and outages can occur. To check the status of the lifts and other facilities at these stations at any given time, please visit the <a href="https://www.hvv.de/en/lifts" target="_blank">HVV website</a>.</p>
	...
	<div>
		<h2 id="dealers-den">The Dealers' Den</h2>
	...
	<div>
		<h2 id="quiet-rooms">The Quiet Rooms</h2>
		<p>Need a break from the noise and crowds? The Quiet Rooms offer a peaceful, low-stimulation environment for rest and recovery.</p>
		<p>While the Quiet Rooms are available and accessible to all attendees, please follow the posted rules to help maintain a calm atmosphere. The Quiet Room’s location can be found in the Conbook, or on the map in the Eurofurence app.</p>
	</div>
	...
	<div>
		<h2 id="accompanying-persons">Accompanying Persons</h2>
	...
	<div>
		<h2 id="gender-neutral-bathrooms">Gender-neutral Bathrooms</h2>
		<p>Both gender-neutral and gender-coded bathrooms will be available and clearly marked throughout the venue.</p>
	</div>

	<div>
		<h2 id="sign-language">Sign Language Interpretation and Live Captioning</h2>
...
<section>
	...
	<p>To get in touch with our dedicated Awareness and Inclusion Team during the convention, please look for team members wearing labelled pink wests, or inquire at the Info Desk or with any staff member to be placed in contact.</p>
</section>
