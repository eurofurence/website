<?php
    ...
    $frontmatter["modified"] = "2026-08-29";
...
<p>We are the ones 
    <ul>
        ...
        <li>answering questions from our beloved attendees, artists and dealers about the Dealer's Den and all areas affiliated with us.</li>
    </ul>
</p>
<p>Being on our team is the perfect way to get immersed in the very heart of action at one of Eurofurence's high-traffic venues. As one of our on-site assistants, you are responsible for assisting the Dealers' Den and all affiliated areas. You have to be familiar with traditional tools such as paper lists as well as digital media, including how to utilize them. You will be trained by us on which products we allow to be displayed on the stands for sale.
    <ul>
        <li>You are sufficiently fluent in English to communicate within our team, the dealers and our attendees. Fluency in German and/or other languages would be a plus.</li>
        <li>You already have knowledge in the field of sales, guest services or have other experience in interacting with customers in a professional manner on site or would like to learn more about this topic.</li>
        <li>You have a sense of how to handle even challenging situations in a calm, de-escalating manner, and always with a smile. In stressful situations, you remain quiet, collected, and professional.</li>
    </ul>
</p>
