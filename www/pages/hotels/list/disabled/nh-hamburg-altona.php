<?php
    $frontmatter["title"] = "nh Hamburg Altona";
    $frontmatter["price"] = "179&ndash;194";
    $frontmatter["metaprice"] = "194";
    $frontmatter['distance'] = "4.7";
    $frontmatter['badge'] = "";
    $frontmatter["breakfast"] = true;
    $frontmatter["email"] = "nhhamburgaltona@nh-hotels.com";
    $frontmatter["code"] = "";
?>
...
<p>💸 Price: 194€ (double room) or 179€ (single room) per night</p>
