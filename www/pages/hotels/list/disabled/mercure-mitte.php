<?php
    $frontmatter["title"] = "Mercure Hamburg Mitte";
    $frontmatter["price"] = "205&ndash;246";
    $frontmatter["metaprice"] = "246";
    $frontmatter['distance'] = "0.8";
    $frontmatter['badge'] = "";
    $frontmatter["breakfast"] = true;
    $frontmatter["email"] = "h5394@accor.com";
...
<p>💸 Price: 246€ (double room) or 205€ (single room) per night</p>
