<?php
    $frontmatter["title"] = "Fraser Suites";
    $frontmatter["price"] = "255&ndash;280";
    $frontmatter["metaprice"] = "280";
    $frontmatter['distance'] = "1.9";
    $frontmatter['badge'] = "";
    $frontmatter["breakfast"] = true;
    $frontmatter["email"] = "reservations.hamburg@frasershospitality.com";
    $frontmatter["code"] = "";
?>
...
<p>💸 Price: 280€ (double room) or 255€ (single room) per night</p>
