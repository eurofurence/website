<?php
    $frontmatter["title"] = "Grand Elys&#233;e";
    $frontmatter["price"] = "300&ndash;320";
    $frontmatter["metaprice"] = "320";
    $frontmatter['distance'] = "0.5";
    $frontmatter['badge'] = "";
    $frontmatter["breakfast"] = true;
    $frontmatter["email"] = "Reservierung@grand-elysee.com";
    $frontmatter["code"] = "";
?>
...
<p>💸 Price: 320€ (double room) or 300€ (single room) per night</p>
