<?php
    $frontmatter["title"] = "ibis Hamburg Alsterring";
    $frontmatter["price"] = "158&ndash;187";
    $frontmatter["metaprice"] = "187";
    $frontmatter['distance'] = "6.0";
    $frontmatter['badge'] = "";
    $frontmatter["breakfast"] = true;
    $frontmatter["email"] = "h3282@accor.com";
...
<p>💸 Price: 187€ (double room) or 158€ (single room) per night</p>
