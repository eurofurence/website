...
<section class="uk-column-1-2@l">
	...
	<p>Dealership applications will be queued into a curated system; the application will be reviewed by the Dealers’ Den Management, approved or declined, then placed. Payment for dealerships is not due until the dealer has confirmed their assigned dealership size. Placement in the room commences thereafter. The period for application will be approximately six weeks.</p>
	<p>Any dealerships not initially accepted will be placed on a waiting list. If a dealership space becomes re-available due to cancellation of another dealer, the next best match based on curation from the waiting list will be contacted. There might be last-minute sales of canceled dealership spaces at the convention itself.</p>
	<p>Once the registration phase for the Dealers' Den has closed, the curation phase will begin. The Dealers' Den team aims to complete the curation process within four weeks. Every applicant will receive a definite response: whether their application has been accepted, placed on the waiting list, or, if necessary, declined due to not meeting the selection criteria.</p>
...
<section class="uk-column-1-2@l">
	<h2 id="ddhours" class="uk-column-span">Dealers’ Den Hours</h2>
	<div>
	...
	<div  class="uk-column-span">
		<hr class="uk-column-span" />
		<p class="uk-column-span">*Subject to Dealers’ Den Management discretion. The room will be completely secured during this time.</p>
	</div>
</section>
<section>
		...
		<caption><h3 class="reset-font">Types and Sizes</h3></caption>
			<thead>
				<tr>
					...
					<th class="uk-text-center uk-text-top">Full Plus<br />■&nbsp;■&nbsp;■</th>
			...
			<tbody>
				<tr>
					...
					<td class="uk-text-center">195&nbsp;cm x 65&nbsp;cm</td>
				...
				<td><h4 class="reset-font">Height</h4></td>
					<td class="uk-text-center" colspan="6">69&nbsp;cm &ndash; 71.5&nbsp;cm<br/>(bottom of table to top of the table)</td>
				</tr>
				<tr>
			...
			<tfoot>
				<tr>
					<td colspan="7">
						Tables are usually located in rows, typically in groups of several tables. Dealerships will be next to each other. The amount of seats is not equal to the amount of chairs and can be individually configured. Electrical power up to 100 Watts average is included. A different table configuration may be offered to a dealership and is subject to availability.
						<br />
...
<section class="uk-column-1-2@l">
	...
	<div>
		<h3 class="reset-font" id="ddobtainingdealershipapproval">Step II: Approval</h3>
		...
		<p>Once the registration phase for the Dealers' Den has closed, the curation phase will begin. The Dealers' Den team aims to complete the curation process within four weeks. Every applicant will receive a definite response: whether their application has been accepted, placed on the waiting list, or, if necessary, declined due to not meeting the selection criteria.</p>
		<p>The Dealers' Den team at Eurofurence is dedicated to supporting emerging talent from the furry community. We reserve some tables exclusively for new dealers, providing them with an opportunity to gain exposure and build an audience. Your 'popularity' &ndash; however that's measured &ndash; is not a factor in the curation process. This includes follower counts on social media, image-sharing platforms, or recognition in furry communities. Our aim is to showcase fresh and diverse talent, and <strong>we encourage new, emerging, and lesser-known artists to apply to the Dealers' Den</strong>.</p>
	...
	<div>
	<h3 class="reset-font" id="ddobtainingdealershipwaitinglist">Waiting List</h3>
	<p>Any dealerships not initially accepted in Step II will be placed on a waiting list curated under the same factors. Information about this status will also be sent to the respective dealer after Step IV is completed. Changes to the original application (including requests for different dealership sizes) via email reply to the waiting list information might lead to a re-evaluation of the application on the waiting list.</p>
		...
		<p>There might be last-minute sales of canceled dealership spaces on a first-come, first-serve basis at the convention itself, starting 12:00 (noon) on Thursday for unclaimed dealerships.</p>
	</div>

	<div>
		<h3 class="reset-font" id="ddobtainingdealershipcancellations">Cancellations</h3>
...
<section>
	...
	<p>
		<ul>
			...
			<li>The maximum overall height of a dealership is the 'reachable height' of 230 cm. This applies to freestanding exhibition stands, standees, flags and other buildups. They must be securely fashioned in a way that prevents them from tipping or falling.</li>
			<li>Any constructions on tables must not exceed a total height of 200 cm when measured from the floor. They must be securely fashioned and/or attached in a way that prevents them from tipping or falling, they must be lightweight enough to preserve the table's overall stability, and they must not cause any damage to the table itself.</li>
...
<section class="uk-column-1-2@l">
	<h2 id="ddopen" class="uk-column-span">The Dealers’ Den is Open!</h2>
	...
	<h3 class="reset-font" id="ddopesguidelinesonmerchandise">Guidelines on Merchandise</h3>
	<p>
		<ul>
			<li>
				...
				<ul>
					<li>Typical items for sale include (but are not limited to) commissions (e.g. badges or sketchbooks), original furry artwork featuring characters with two, four, or any number of limbs or body configurations, as well as prints, digital media, furry-themed jewelry, fursuit materials, and plushies made of faux fur.
					</li>
				</ul>
			</li>
			<li>
	...
	<h3 class="reset-font" id="ddopenguidelinesonsales">Guidelines on Sales</h3>
	...
	<h3 class="reset-font" id="ddopenguidelinesonactivities">Guidelines on Activities</h3>
	<p>
		<ul>
...
<section>
	...
	<ul>
		...
		<li>Dealers are <strong>required to check out</strong> with Dealers’ Den Staff. Upon checkout, the dealer's respective dealership will be inspected by staff. Please visit the help desk to complete your checkout process.</li>
...
<section>
	<p>Please note that all details provided on this website are subject to change until the official registration starts. We recommend checking for updates regularly.</p>
</section>
