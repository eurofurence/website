...
<section>
	...
	<div class="uk-column-1-2@l">
		...
		<div>
			...
			<p>The Artist Alley will be open from <strong>Thursday at 11:00 as well as Friday and Saturday at 10:00 until 02:00 in the morning</strong> during Eurofurence. Please adhere to these hours for all setup, sales, and tear-down activities.</p>
		</div>
		...
		<div>
			...
			<p>Registration for the Artist Alley operates on a "<strong>First come, first serve</strong>" basis each day of the convention. There are <strong>no advance reservations</strong> possible, some tables have priority access (see below). If you follow the rules, you are welcome to sell your goods in the Artist Alley. Each artist or dealer may occupy <strong>up to one full table</strong> (130 cm width) with two chairs, which can be used individually or shared with fellow artists. <strong>Sharing a table is encouraged</strong> to give more artists a chance to participate. The table layout is fixed: <strong>No moving, rotating, stacking, removing or adding tables</strong> please!</p>

			<p>If you have found a spot, you <strong>must</strong> do a <strong>check-in with the Eurofurence app,</strong> which includes taking a picture of your table, describing your offerings and agreeing to the rules. This will also be <strong>shown to all attendees</strong> in the app, helping to promote the Artist Alley. The Dealer’s Den <strong>Staff needs to confirm all check-ins.</strong> Please be patient with us!</p>

			<p>When you are <strong>done selling</strong> or want to take a <strong>longer break,</strong> we kindly ask you to <strong>please clear your table to give others a chance</strong>. If you want to work on commissions you took, we invite you to check out the Artist’s Lounge.</p>
		</div>
		...
		<div>
			...
			<ul>
			<li><strong>Identification and Check-In:</strong> Participants must be registered attendees of Eurofurence and identified by their convention badge. The <strong>check-in is mandatory</strong> for all artists and dealers who wish to set up shop at a table in the Artist Alley!</li>

			<li><strong>No Advance Reservations:</strong> Tables are allocated on a daily <strong>first-come, first-serve</strong> basis and can not be reserved. Some tables are marked with a “<strong>Priority Access</strong>” sign. These tables can be used by everyone but must be available to artists with <strong>accessibility needs</strong> (e.g., for wheelchair use) upon request, similar to priority seating in public transport. Please <strong>consult the Dealer’s Den Staff at the Artist Alley Help Desk to claim</strong> priority access and in case of disputes or questions.</li>
			...
			<li><strong>Compliance:</strong> The Dealers' Den Directors and their appointed deputies and assistants may instruct artists and dealers to remove material, merchandise or anything else on display or vacate their table if compliance issues arise. </li>
			</ul>
		</div>
		...
		<div>
			...
			<li><strong>End of Sales:</strong> Artists and dealers are expected to clear their tables if they have completed their sales activities for the day or take a longer break, allowing opportunities for others. <strong>After three hours you will be checked-out automatically.</strong></li>
			</ul>
		</div>
		...
		<div>
			...
			<ul>
			<li>Any item that is prohibited for sale is also not permitted for display, giveaway, advertisement or delivery. Items generally prohibited for sale include, but are not limited to: </li>
			<ul>
			...
			<ul>
			<li>The sale of food and beverages for direct consumption is not allowed anywhere in the Convention Center, including the Artist’s Alley. Consumable items in closed containers are not permitted for sale in the Artist’s Alley either. </li>

			<li>The <strong>display, sale or offering</strong> of items (physical or digital) and services that reproduce or otherwise directly imitate third parties’ <strong>copyrighted material</strong> <strong>without</strong> explicit, personal, written <strong>permission from the copyright holder is strictly prohibited</strong>. The responsibility to ensure proper permission for use of copyrighted material rests solely with the artist or dealer. It is the Dealer's responsibility to ensure that the personal, written permission for the copyrighted material is available to Dealer's Den management in either English or German. Other languages require a certified written translation. The permission must not be more than 12 months old.</li>
			</ul>

			<p>If an item or service requires a specific permit or a license for offering or selling the item or service, the artist or dealer is required to present the permit or license upon request at any time.</p>
			...
			<p>Unlike Common Law countries, the German copyright law does not include a general Fair Use / Fair Dealing exception. Dealers and artists are advised to inform themselves about compliance with European and German copyright law, applicable trademarks, as well as topics like parodies and fan art prior to their attendance. The Eurofurence Dealers’ Den Staff must not give any legal advice on this matter.</p>
		...
		<div>
			...
			<p>During the Artist Alley's operating hours, a member of the Dealers' Den Staff will always be available to provide assistance and answer questions. A local Artist Alley Help Desk will be staffed by a member of the Dealers' Den team most of the opening times as a first point of contact. You can contact the Dealers' Den management at the Dealers' Den Help Desk during the official Dealers' Den opening hours. Outside of these hours, the team can be reached through the Eurofurence Security Desk. </p>

			<p>The regulations governing the Artist Alley are supplementary to the existing rules of the Dealers' Den. The Dealers' Den rules also apply significantly to the Artist Alley and can be reviewed in detail here: <a href="https://www.eurofurence.org/EF30/dealersden" target="_blank">Dealers' Den Rules</a>. Additionally, the Artist Alley is subject to further rules and restrictions listed on this site. </p>
			...
			<p>All decisions made by the Dealers’ Den Management regarding any issues related to Artist Alley operations are final. If there is any uncertainty regarding the rules, please do not hesitate to ask for clarification. We are here to help and provide answers to all your questions. However, please understand that while we welcome inquiries, we will not engage in debates about these rules during the convention. </p>

			<p>The Dealers’ Den Management reserves the right to revoke their Artist Alley participation, access to the Artist Alley, or any other privileges regarding the Artist Alley and the Dealers' Den at any time for any reason, without issuing a refund. </p>
